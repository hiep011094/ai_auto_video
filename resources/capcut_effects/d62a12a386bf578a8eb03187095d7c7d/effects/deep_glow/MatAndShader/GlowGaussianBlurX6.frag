...
uniform sampler2D u_InputTexX6;
...
void main()
{
    float theta = 0.0 / 180.0 * 3.1415926;
    ...
    vec4 color = gaussianBlur(u_InputTexX6, uv0, dir, u_Strength);
    gl_FragColor = color;
}
